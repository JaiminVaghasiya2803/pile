...
import { loginUser, enterAsGuest, clearError } from '../../store/slices/authSlice';
...
const LoginScreen: React.FC<LoginScreenProps> = ({ navigation }) => {
  ...
  const formSection = useMemo(
    ...
    [styles, formData, showPassword, isLoading, handleInputChange, toggleShowPassword, handleSignIn]
  );
